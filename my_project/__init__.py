...
from my_project.trip.route import register_routes as register_trip_routes
...
def _init_swagger(app: Flask) -> None:
    # A-lia Swagger
    restx_api = Api(app, title='TripAdvisor-like backend',
                    description='Backend for establishments, owners, and reviews')  # https://flask-restx.readthedocs.io/
